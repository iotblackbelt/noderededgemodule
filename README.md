...
<li>In the <strong>Image URI</strong> field, enter <code>gbbiotwesouth/noderedmodule:0.6.3-amd64</code> or <code>gbbiotwesouth/noderedmodule:0.6.3-arm32v7</code>. </li>
